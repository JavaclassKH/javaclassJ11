...
<c:set var="ctpimg" value="${pageContext.request.contextPath}/images"/>
...
<h2 class="text-center"><strong><font size="16em">아이브 소개</font></strong></h2>
  ...
  <c:forEach var="vo" items="${vos}" varStatus="st">
	  <div class="row">
		  <c:if test="${vo.IVEName == '가을'}">
			  <div class="card" style="width:400px">
			    <img class="card-img-top" src="${ctpimg}/${vo.photo}" alt="Card image" style="width:100%">
			    <div class="card-body">
			      <h4 class="card-title">가을</h4>
			      <p class="card-text">
			      	이름: 김가을 &nbsp;&nbsp; 생년월일: 2002-09-24<br/>
			      	포지션: ${vo.positions} &nbsp;&nbsp; MBTI: ${vo.mbti} &nbsp;&nbsp;<br/>
			      	MINIVE: 달이<br/>
			      	대표 별명: ${vo.nickNames}<br/>
			      	<br/><br/>
			      	<b>- 소개 -</b><br/>
			      	${vo.introduce}<br/>
			  ...
			  <div class="card" style="width:400px; margin-left:60px;">
			    ...
			    <div class="card-body">
			      ...
			      <p class="card-text">
			      	...
			      	포지션: <b>${vo.positions}</b>, 보컬 &nbsp;&nbsp; MBTI: ${vo.mbti} &nbsp;&nbsp;<br/>
			      	MINIVE: 강안지<br/>
			      	대표 별명: ${vo.nickNames}<br/><br/><br/>
			      	<b>- 소개 -</b><br/>
			      	${vo.introduce}<br/>
